...
export default function OpsLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', { event: 'INSERT', schema: 'public', table: 'chat_messages' }, () => void refreshCounts())
  ...
  const navGroups = [
    ...
    },
    {
      label: 'Intelligence',
      items: [
        { href: '/ops/database', label: 'Database', icon: <DatabaseIcon /> },
      ],
    },
    {
      label: 'Internal',
    ...
    },
    {
      label: 'Account',
      items: [
        { href: '/ops/profile', label: 'My Profile', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> },
      ],
    },
  ]
