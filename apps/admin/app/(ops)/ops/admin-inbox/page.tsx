          ...
          {!selected ? (
            ...
            <div className="p-6 space-y-5 max-w-2xl">
              ...
              {selected.resolution_note && (
                <div className={`rounded-xl p-4 ${selected.status === 'resolved' ? 'bg-green-900/10 border border-green-800/30' : 'bg-ops-900/10 border border-ops-800/30'}`}>
                  <p className={`text-xs font-semibold uppercase tracking-wider mb-1 ${selected.status === 'resolved' ? 'text-green-400' : 'text-ops-400'}`}>
                    Admin Reply
                  </p>
